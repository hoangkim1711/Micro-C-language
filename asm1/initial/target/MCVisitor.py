...
class MCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MCParser#exp_state.
    def visitExp_state(self, ctx:MCParser.Exp_stateContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MCParser#assign_state.
    def visitAssign_state(self, ctx:MCParser.Assign_stateContext):
        return self.visitChildren(ctx)
